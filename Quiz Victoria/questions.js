var questions = [
    ...
    ["(Unicamp 2018)  Considere que o quadrado ABCD  representado na figura abaixo, tem lados de comprimento de 1cm, e que C é o ponto médio do segmento AE  Consequentemente, a distância entre os pontos D  e  E será igual a",
        "a", "b", "c", "d","nada",
        "img/ex1.png", "", "", "", "","",
        "3"
    ],
    ...
    ["TEXTO PARA A PRÓXIMA QUESTÃO: Considere o texto e a ilustração a seguir para responder à(s) questão(ões) a seguir.A fabricação de uma peça triangular de vértices A, B e C, a partir da qual será construída uma pirâmide aberta (sem a face APC), exige as seguintes especificações: ",
        "a", "b", "c", "d","e",
        "img/ex2.png", "", "", "", "","",
        "2"
    ],

    ["(Fuvest 2017)  O paralelepípedo reto-retângulo ABCDEFGH  representado na figura, tem medida dos lados AB= 4, BC= 2  e BF= 2 ",
        "a", "b", "c", "d","e",
        "img/ex3.png", "", "", "", "","",
        "5"
    ],
